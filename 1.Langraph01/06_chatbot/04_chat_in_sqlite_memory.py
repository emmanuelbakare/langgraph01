...
#add memory using sqlite -  (first pip install langgraph-checkpoint-sqlite)
sql_saver = sqlite3.connect("checkpoint.sqlite", check_same_thread=False)
memory = SqliteSaver(sql_saver)
